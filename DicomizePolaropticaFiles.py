...
orthanc_server = "http://localhost:8042" #"https://naturalheritage.africamuseum.be/Orthanc"
...
for image_name in images:
    ...
    ds.StudyID = None
    ds.StudyDescription = "Lame meteorite polarisee"
    ...
    if(thumbnail_buffer):
        r = requests.put(f'{orthanc_server}/instances/{uuid}/attachments/thumbnail', data=thumbnail_buffer.getvalue())
    i += 1
